...
#include "repo/Solver.h"
#include "AlloyMiniSatProver.h"

#define NS(name) Java_org_alloytools_solvers_natv_minisatprover_MiniSatProver_ ## name
 ...
 */
JNIEXPORT jobjectArray JNICALL NS(trace)
