...
public class AddAllSnapshotsDifferentPredFact {
    /*
    ...
    */
    private static List<Expr> addAllSnapshotsDifferentBody(DashModule d) {
    ...
    public static void addAllSnapshotsDifferentPred(DashModule d) {
        ArrayList<Decl> nodecls = new ArrayList<Decl>();
        d.alloyString += d.addPredSimple(DashStrings.allSnapshotsDifferentName,nodecls, addAllSnapshotsDifferentBody(d));
    }

    public static void addAllSnapshotsDifferentFact(DashModule d) {
        ArrayList<Decl> nodecls = new ArrayList<Decl>();
        d.alloyString += d.addFactSimple(DashStrings.allSnapshotsDifferentName, addAllSnapshotsDifferentBody(d));
    }
}