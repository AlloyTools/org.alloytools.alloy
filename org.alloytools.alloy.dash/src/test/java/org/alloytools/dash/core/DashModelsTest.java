...
public class DashModelsTest {
    ...
    public void testTransitionAllCommands() throws Exception {
        ...
        if (!transitions.get(0).whenExpr.exprList.get(0).toString().equals("s.concState_var_one = none"))
        throw new Exception("Transition when Expr not stored correctly. Expected is: s.concState_var_one = none, Actual is: " + transitions.get(0).whenExpr.exprList.get(0).toString());
        ...
        if (!transitions.get(1).doExpr.exprList.get(0).toString().equals("var_one' = var_one"))
            throw new Exception("Transition do Expr not stored correctly.");
        if (!transitions.get(1).whenExpr.exprList.get(0).toString().equals("s.concState_var_one = none"))
        throw new Exception("Transition when Expr not stored correctly. Expected is: s.concState_var_one = none, Actual is: " + transitions.get(1).whenExpr.exprList.get(0).toString());
