...
public class BugTests extends TestCase {
    ...
    public final void testFelix_11262007() {
        ...
        solver.options().setSymmetryBreaking(20);
        solver.options().setSkolemDepth(0);
        final Set<Decl> decls = new LinkedHashSet<>();
    ...
    private static boolean isMinimal(Solver solver, Bounds bounds, Set<Formula> core) {
        final Set<Formula> minCore = new LinkedHashSet<>(core);
    ...
    public final void testFelix_08142006() {
        ...
        java.util.ArrayList<String> atomlist = new java.util.ArrayList<>();
        for (String a : atoms)
            atomlist.add(a);
        Universe universe = new Universe(atomlist);
        TupleFactory factory = universe.factory();
    ...
    public final void testVincent_03182006_reduced() {
        ...
        final List<String> atoms = new ArrayList<>(14);
        atoms.add("6.002");
        atoms.add("8.02");
        atoms.add("6.003");
        atoms.add("6.001");
    ...
    public final void testVincent_02182006() {
        ...
        final List<Integer> atoms = new ArrayList<>();
    ...
    public final void testEmina_01232006() {
        final List<String> atoms = new ArrayList<>(5);
        for (int i = 0; i < 5; i++)
            atoms.add("a" + i);
        final Universe u = new Universe(atoms);
    ...
    public final void testGreg_11232005() {
        final List<String> atoms = new ArrayList<>(3);
        atoms.add("-1");
        atoms.add("0");
        atoms.add("1");
        final Universe u = new Universe(atoms);
    ...
    public final void testGreg_01052006() {
        ...
        final List<Object> atoms = new ArrayList<>(12);
        atoms.add(2);
        atoms.add(4);
        atoms.add(-2);
        atoms.add("null");
    ...
    private final void doTestAleks_03102013() {
        ...
        List<Object> atomlist = new LinkedList<>();
        atomlist.add("R$0");
        atomlist.add("R$1");
        atomlist.add("R$2");
