...
public final class SET943 {
    ...
    public final Formula t8_xboole_1() {
        ...
        final Variable b = Variable.unary("B");
        final Variable c = Variable.unary("C");
        return subset(a, b).and(subset(c, b)).implies(subset(set_union2(a, c), b)).forAll(a.oneOf(UNIV).and(b.oneOf(UNIV)).and(c.oneOf(UNIV)));
    }
    ...
    public final Formula axioms() {
        return decls().and(antisymmetry_r2_hidden()).and(commutativity_k2_xboole_0()).and(d10_xboole_0()).and(d2_xboole_0()).and(d3_tarski()).and(d4_tarski()).and(fc2_xboole_0()).and(fc3_xboole_0()).and(idempotence_k2_xboole_0()).and(rc1_xboole_0()).and(rc2_xboole_0()).and(reflexivity_r1_tarski()).and(t7_xboole_1()).and(t8_xboole_1()).and(t95_zfmisc_1());
    }
    ...
    public final Formula t96_zfmisc_1() {
        final Variable a = Variable.unary("A");
        final Variable b = Variable.unary("B");
        return union(set_union2(a, b)).eq(set_union2(union(a), union(b))).forAll(a.oneOf(UNIV).and(b.oneOf(UNIV)));
    }
