...
/**
 * Contains the relations/axioms common to the problems ALG195+1.p and
 * ALG197+1.p from from http://www.cs.miami.edu/~tptp/
 *
 * @author Emina Torlak
 */
public abstract class Quasigroups7 {
    ...
    public final Formula decls() {
        final List<Formula> formulas = new ArrayList<>(2 + h.length);
    ...
    private Expression op1(Expression arg1, Expression arg2) {
        return arg1.join(arg2.join(op1));
    }

    private Expression op2(Expression arg1, Expression arg2) {
        return arg1.join(arg2.join(op2));
    }
