...
public final class SET948 {
	...
	public final Formula d3_xboole_0() {
		...
		final Variable b = Variable.unary("B");
		final Variable c = Variable.unary("C");
		return c.eq(set_intersection2(a, b)).iff(in.join(c).eq(in.join(a).intersection(in.join(b)))).forAll(
				a.oneOf(UNIV).and(b.oneOf(UNIV)).and(c.oneOf(UNIV)));
	}
	...
	public final Formula axioms() {
		return decls().and(antisymmetry_r2_hidden())
				...
				.and(idempotence_k3_xboole_0())
				.and(rc1_xboole_0())
				.and(rc2_xboole_0())
				.and(reflexivity_r1_tarski())
				.and(symmetry_r1_xboole_0())
				.and(t4_xboole_0())
				.and(t97_zfmisc_1());
	}
