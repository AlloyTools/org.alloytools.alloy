...
public final class SET967 {
	...
	public final Formula d2_xboole_0() {
		...
		return c.eq(set_union2(a, b)).iff(in.join(c).eq(in.join(a).union(in.join(b)))).forAll(
				a.oneOf(UNIV).and(b.oneOf(UNIV)).and(c.oneOf(UNIV)));
	}
	...
	public final Formula d5_tarski() {
		final Variable a = Variable.unary("A");
		final Variable b = Variable.unary("B");
		return ordered_pair(a, b).eq(unordered_pair(unordered_pair(a, b), singleton(a)))
	...
	public final Formula t4_xboole_0() {
		final Variable a = Variable.unary("A");
		final Variable b = Variable.unary("B");
		return disjoint(a, b).not()
				.implies(set_intersection2(a, b).some())
	...
	public final Formula t112_zfmisc_1() {
		...
		final Formula f2 = in(ordered_pair(c, d), a).iff(in(ordered_pair(c, d), b))
	...
	public final Formula axioms() {
		return decls().and(antisymmetry_r2_hidden())
				.and(commutativity_k2_xboole_0())
				.and(commutativity_k2_tarski())
				.and(d2_xboole_0())
				.and(d5_tarski())
				.and(fc1_misc_1())
				.and(fc2_xboole_0())
				.and(fc3_xboole_0())
				.and(idempotence_k2_xboole_0())
				.and(a155_zfmisc_1())
				.and(rc1_xboole_0())
				.and(rc2_xboole_0())
				.and(t102_zfmisc_1())
	...
	public final Formula t120_zfmisc_1() {
		...
		final Variable b = Variable.unary("B");
		final Variable c = Variable.unary("C");
		final Formula f0 = cartesian_product2(set_union2(a, b), c)
				.eq(set_union2(cartesian_product2(a, c), cartesian_product2(b, c)));
		final Formula f1 = cartesian_product2(c, set_union2(a, b))
				.eq(set_union2(cartesian_product2(c, a), cartesian_product2(c, b)));
