...
public class OverflowTestUtils {
    ...
    public static void assertInstance(Solution[] sols) {
        for (Solution sol : sols) assertInstance(sol);
    }
    ...
    public static void assertNoInstance(Solution[] sols) {
        for (Solution sol : sols) assertNoInstance(sol);
    }
    ...
    public static int min(int bw) { return -(1 << (bw - 1)); }
    public static int max(int bw) { return (1 << (bw - 1)) - 1; }
