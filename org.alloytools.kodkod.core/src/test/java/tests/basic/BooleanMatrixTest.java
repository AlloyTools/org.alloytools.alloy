...
public class BooleanMatrixTest extends TestCase {
	 ...
	 *         cell in the given array of formulas. The method assumes that
	...
	/**
	 * @effects sets the cells in m and the array, from range.min() to
	 *          range.max(), to the corresponding values in vars.
	 */
	...
	/**
	 * @effects m'.elements = m.elements ++ index->FALSE && cells'[index] =
	 *          FALSE
	 */
