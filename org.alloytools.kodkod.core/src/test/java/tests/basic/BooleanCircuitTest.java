...
public class BooleanCircuitTest extends TestCase {
	...
	private final void testParenthesis(BooleanValue result, Operator.Nary op, BooleanValue p, BooleanValue q,
	...
	private final void testCommutativityAndAssociativity(Operator.Nary op, BooleanValue p, BooleanValue q,
			BooleanValue r, BooleanValue s) {
