...
public class AlloyAtomTest {
    ...
    public void testRelationOperations() {
        Solution s = ai.getSolution(//
                                    ...
                                    "u=a+b i=a&b dab=a-b dba=b-a ab=a->b ba=b->a ab_b=ab.b ba_a=ab.b bah=ba.univ " + //
                                    "abh=ab.univ bat=univ.ba abt=univ.ab aba=ab->a" + //
                                    "aba=ab->a" + //
                                    "} run foo");
